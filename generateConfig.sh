...
EOF
printf $SERVERS | awk -v server_max_connection="$SERVER_MAX_CONNECTION" -F ':' 'BEGIN { RS = ";" } ; { print "    server node-"NR,$1":"$2" maxconn",server_max_connection,"check cookie","node-"NR }'
echo
